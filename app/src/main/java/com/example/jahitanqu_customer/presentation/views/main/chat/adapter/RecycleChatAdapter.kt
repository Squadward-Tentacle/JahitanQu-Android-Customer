...
import com.example.jahitanqu_customer.model.Message

/**
 * Created by Maulana Ibrahim on 11/September/2020
 * Email maulibrahim19@gmail.com
 */
class RecycleChatAdapter(private val chatList:List<Message>):RecyclerView.Adapter<RecycleChatViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleChatViewHolder, position: Int) {
        holder.chatText.text = chatList[position].message
        holder.chatUser.text = chatList[position].username
    }
}